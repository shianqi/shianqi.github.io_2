    ...
    render() {
        return(
            <div className="full" id="title">
                ...
                <label className="titleLabel" onClick={this.onclick3.bind(this)}><span>ABOUT</span></label>
                <input data-number="2" id="inputMessage" type="checkbox" name="title" checked={this.getCheckedState(2)}/>
                <label className="titleLabel" onClick={this.onclick2.bind(this)}><span>MESSAGE</span></label>
                <input data-number="1" id="inputHome" type="checkbox" name="title" checked={this.getCheckedState(1)}/>
                <label className="titleLabel" onClick={this.onclick1.bind(this)}><span>HOME</span></label>
